...
#'
#' A two-sample summary level dataset, Richmond et al. (2017) <https://dx.doi.org/10.1101/155739>, containing 14 single nucleiodtide polymorphisms (SNPs) which have genotype-phenotype associations (BMI) and genotype-outcome associations (insulin) with their respective standard errors.
#'
#' bmi_insulin.
#'
