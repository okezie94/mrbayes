...
test_that("Radial-Egger using default prior method", {
  ...
  radialeggerfit <- mr_radialegger_rjags(
    dat,
    seed = c(123, 456, 789),
  ...
  expect_equal(unname(radialeggerfit$StandardError), 0.0799, tol = 1e-2)
  expect_equal(unname(radialeggerfit$CredibleInterval[1]), 0.432, tol = 1e-2)
  expect_equal(unname(radialeggerfit$CredibleInterval[2]), 0.591, tol = 1e-2)
  expect_equal(unname(radialeggerfit$CredibleInterval[3]), 0.743, tol = 1e-2)
  expect_equal(unname(radialeggerfit$AvgPleio), -0.252, tol = 1e-2)
  expect_equal(unname(radialeggerfit$sigma), 1.58, tol = 1e-2)
...
test_that("Radial-Egger using weak prior method", {
  ...
  radialeggerfit1 <- mr_radialegger_rjags(
    dat,
    prior = "weak",
    seed = c(123, 456, 789),
    sigmaprior = "dunif(1,10)"
  ...
  expect_equal(unname(radialeggerfit1$StandardError), 0.0799, tol = 1e-2)
  expect_equal(unname(radialeggerfit1$CredibleInterval[1]), 0.432, tol = 1e-2)
  expect_equal(unname(radialeggerfit1$CredibleInterval[2]), 0.591, tol = 1e-2)
  expect_equal(unname(radialeggerfit1$CredibleInterval[3]), 0.743, tol = 1e-2)
  expect_equal(unname(radialeggerfit1$AvgPleio), -0.252, tol = 1e-2)
  expect_equal(unname(radialeggerfit1$sigma), 1.58, tol = 1e-2)
...
test_that("Radial-Egger using pseudo prior method", {
  ...
  radialeggerfit2 <- mr_radialegger_rjags(
    dat,
    prior = "pseudo",
    seed = c(123, 456, 789),
    sigmaprior = "dunif(1,10)"
  ...
  expect_equal(unname(radialeggerfit2$StandardError), 0.0799, tol = 1e-2)
  expect_equal(unname(radialeggerfit2$CredibleInterval[1]), 0.432, tol = 1e-2)
  expect_equal(unname(radialeggerfit2$CredibleInterval[2]), 0.586, tol = 1e-2)
  expect_equal(unname(radialeggerfit2$CredibleInterval[3]), 0.743, tol = 1e-2)
  expect_equal(unname(radialeggerfit2$AvgPleio), -0.245, tol = 1e-2)
  expect_equal(unname(radialeggerfit2$sigma), 1.58, tol = 1e-2)
...
test_that("Radial-Egger using joint prior method", {
  ...
  radialeggerfit3 <- mr_radialegger_rjags(
    dat,
    prior = "joint",
    seed = c(123, 456, 789),
    rho = 0.5,
  ...
  expect_equal(unname(radialeggerfit3$StandardError), 0.0799, tol = 1e-2)
  expect_equal(unname(radialeggerfit3$CredibleInterval[1]), 0.432, tol = 1e-2)
  expect_equal(unname(radialeggerfit3$CredibleInterval[2]), 0.591, tol = 1e-2)
  expect_equal(unname(radialeggerfit3$CredibleInterval[3]), 0.743, tol = 1e-2)
  expect_equal(unname(radialeggerfit3$AvgPleio), -0.253, tol = 1e-2)
  expect_equal(unname(radialeggerfit3$sigma), 1.58, tol = 1e-2)
...
test_that("Radial-Egger using betaprior and sigmaprior method", {
  ...
  radialeggerfit4 <- mr_radialegger_rjags(
    dat,
  ...
  expect_equal(unname(radialeggerfit4$StandardError), 0.0799, tol = 1e-2)
  expect_equal(unname(radialeggerfit4$CredibleInterval[1]), 0.432, tol = 1e-2)
  expect_equal(unname(radialeggerfit4$CredibleInterval[2]), 0.591, tol = 1e-2)
  expect_equal(unname(radialeggerfit4$CredibleInterval[3]), 0.743, tol = 1e-2)
  expect_equal(unname(radialeggerfit4$AvgPleio), -0.252, tol = 1e-2)
  expect_equal(unname(radialeggerfit4$sigma), 1.58, tol = 1e-2)
