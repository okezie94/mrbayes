...
test_that("Radial-Egger using default prior method",
          {
            ...
            expect_equal(unname(radialeggerfit$psi), 0.404, tol = 1e-2)
...
test_that("Radial-Egger using weak prior method",
          {
            skip_on_cran()
            radialeggerfit1 <- mr_radialegger_rjags(mrdat, methods = "weak", seed = 123)
            ...
            expect_equal(unname(radialeggerfit1$psi), 0.404, tol = 1e-2)
...
test_that("Radial-Egger using pseudo prior method",
          {
            skip_on_cran()
            radialeggerfit2 <- mr_radialegger_rjags(mrdat, methods = "pseudo", seed = 123)
            ...
            expect_equal(unname(radialeggerfit2$psi), 0.404, tol = 1e-2)
