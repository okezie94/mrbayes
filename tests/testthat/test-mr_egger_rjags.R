...
test_that("MR-Egger using default prior method", {
  ...
  eggerfit <- mr_egger_rjags(dat, seed = c(123, 456, 789))
...
test_that("MR-Egger using weak prior method", {
  ...
  eggerfit1 <-
    mr_egger_rjags(dat, prior = "weak", seed = c(123, 456, 789))
...
test_that("MR-Egger using pseudo prior method", {
  ...
  eggerfit2 <-
    mr_egger_rjags(dat, prior = "pseudo", seed = c(123, 456, 789))
...
test_that("MR-Egger using joint prior method", {
  ...
  eggerfit3 <-
    mr_egger_rjags(dat, prior = "joint", seed = c(123, 456, 789))
