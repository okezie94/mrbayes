...
public:
  ~model_mrivw() {}
  model_mrivw(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mrivw_namespace::model_mrivw";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mrivw_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mrivw_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"estimate\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
  }
