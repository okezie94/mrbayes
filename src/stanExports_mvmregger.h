...
public:
  ~model_mvmregger() {}
  model_mvmregger(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mvmregger_namespace::model_mvmregger";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = 1 + d + 1;
  }
  inline std::string model_name() const final {
    return "model_mvmregger";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mvmregger_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      sigma = in__.template read<local_scalar_t__>();
      {
        ...
        if (stan::math::logical_eq(prior, 1)) {
          ...
          lp_accum__.add(stan::math::normal_lpdf<propto__>(ybeta,
                           stan::math::add(
                             stan::math::multiply(intercept, weights),
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mvmregger_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"intercept", "estimate", "sigma"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"intercept\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"estimate\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(d) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((1 + d) + 1);
