...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mvmregger");
    reader.add_event(67, 65, "end", "model_mvmregger");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mvmregger
  : public stan::model::model_base_crtp<model_mvmregger> {
private:
        int n;
        int d;
        vector_d ybeta;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "xbeta", "matrix_d", context__.to_vec(n,d));
            xbeta = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, d);
            vals_r__ = context__.vals_r("xbeta");
            pos__ = 0;
            size_t xbeta_j_2_max__ = d;
            size_t xbeta_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < xbeta_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < xbeta_j_1_max__; ++j_1__) {
                    xbeta(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("estimate", "d", d);
        context__.validate_dims("parameter initialization", "estimate", "vector_d", context__.to_vec(d));
        Eigen::Matrix<double, Eigen::Dynamic, 1> estimate(d);
        size_t estimate_j_1_max__ = d;
        for (size_t j_1__ = 0; j_1__ < estimate_j_1_max__; ++j_1__) {
            estimate(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(estimate);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 29;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> estimate;
            (void) estimate;  // dummy to suppress unused var warning
            if (jacobian__)
                estimate = in__.vector_constrain(d, lp__);
            else
                estimate = in__.vector_constrain(d);
            current_statement_begin__ = 30;
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> estimate = in__.vector_constrain(d);
        size_t estimate_j_1_max__ = d;
        for (size_t j_1__ = 0; j_1__ < estimate_j_1_max__; ++j_1__) {
            vars__.push_back(estimate(j_1__));
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < estimate_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "estimate" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
...
typedef model_mvmregger_namespace::model_mvmregger stan_model;
#ifndef USING_R
