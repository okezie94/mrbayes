...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mrradialegger");
    reader.add_event(90, 88, "end", "model_mrradialegger");
    return reader;
}
#include <stan_meta_header.hpp>
class model_mrradialegger : public prob_grad {
private:
        int n;
        vector_d ybeta;
        vector_d xbeta;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(prior, 1))) {
                ...
                lp_accum__.add(normal_log<propto__>(intercept, 0, 100));
                current_statement_begin__ = 55;
                lp_accum__.add(normal_log<propto__>(estimate, 0, 100));
                current_statement_begin__ = 56;
                lp_accum__.add(uniform_log<propto__>(sigma, 1, 10));
                current_statement_begin__ = 59;
                lp_accum__.add(normal_log<propto__>(ybeta, add(intercept, multiply(xbeta, estimate)), sigma));
                ...
                lp_accum__.add(normal_log<propto__>(ybeta, add(get_base1(eta, 1, "eta", 1), multiply(xbeta, get_base1(eta, 2, "eta", 1))), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
...
typedef model_mrradialegger_namespace::model_mrradialegger stan_model;
#endif
